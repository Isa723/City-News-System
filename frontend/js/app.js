...
// Initialize Google Map (called by Google Maps JS callback)
function initMap() {
    ...
    // Once map is ready, load the news (last 3 days already enforced by backend scraper)
    loadNews();
}
...
const categoryPaths = {
    ...
    "Yangın": "M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8c0-6-4-10.74-4-10.74l-2.5-2.59zM11.89 19.74c-2.32 0-4.2-1.88-4.2-4.2 0-1.2.5-2.29 1.3-3.07.06-.06.27-.24.27-.24l1.37-1.3s1.26 1.13 1.26 3.58c0 1.05.85 1.91 1.91 1.91s1.91-.85 1.91-1.91c0-2-1-3.6-1-3.6s2.5 1.6 2.5 5.56c.01 2.32-1.87 4.27-4.19 4.27z",
    "Elektrik Kesintisi": "M7 2v11h3v9l7-12h-4l4-8z",
    "Hırsızlık": "M17 12c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0 8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zM12 17c0-2.76-2.24-5-5-5s-5 2.24-5 5 2.24 5 5 5 5-2.24 5-5zm-5 3c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm15-4v-1c0-4.42-3.58-8-8-8s-8 3.58-8 8v1c-1.1 0-2 .9-2 2v3c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-3c0-1.1-.9-2-2-2z",
    "Kültürel Etkinlikler": "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm4.5-9c.83 0 1.5-.67 1.5-1.5S17.33 8 16.5 8s-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm-9 0c.83 0 1.5-.67 1.5-1.5S8.33 8 7.5 8s-1.5.67-1.5 1.5.67 1.5 1.5 1.5zm4.5 4.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z"
};
...
// Fetch all news once and filter on client
...
function renderMarkers(filteredData) {
    ...
    filteredData.forEach(news => {
        ...
        const catColor = categoryColors[news.category] || "#707070";
        ...
        const catClass = categoryClasses[news.category] || "cat-trafik";
...
// Client-side filters: category, district, date (last 3 days window)
